	var newsLis = $("#notice_ul").children();// 获取li子节点集合
	var count = newsLis.length;// li子节点集合大小，即总记录数
	var ONE_PAGE_COUNT = 8;// 页面大小
	var totalPage = parseInt(count / ONE_PAGE_COUNT) + ((count % ONE_PAGE_COUNT) == 0? 0 : 1);// 总页数
	var currPage = 1;// 初始化页数
	var serviceCode = "00000110003";//服务编码
	var fenLeiID = "F6E61E66-20BF-419D-AE91-48C7E04195CE";//分类id
	var currentNode=5;
